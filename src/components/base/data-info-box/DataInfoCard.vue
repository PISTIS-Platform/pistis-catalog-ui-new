...
<template>
  <component
    ...
    :to="props.to || '/'"
    class="group relative mx-auto box-border rounded-custom by w-full border-neutral-20 border-b-transparent bg-surface text-surface-text p-12 hover:border-b-primary mb-6"
  >
    <!-- Header -->
