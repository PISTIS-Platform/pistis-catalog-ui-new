...
import type { SplitButtonProps, SplitButtonSlots } from 'primevue/splitbutton'
import type { LooseAutocomplete } from '../../../utils/types'
// import Button, { type ButtonProps, type ButtonSlots } from 'primevue/button'
import SplitButton from 'primevue/splitbutton'
import { computed, useAttrs } from 'vue'

type Severity = 'secondary' | 'success' | 'info' | 'warning' | 'help' | 'danger' | 'contrast'

export interface Props extends /* @vue-ignore */ SplitButtonProps {
...
const mySlots = defineSlots<SplitButtonSlots>()
const slotNames = Object.keys(mySlots) as 'default'[]
  ...
  button: {
    root: ({ parent }: { parent: any }) => ({
      class: [
        ...
        'leading-[normal]',
        {
          'h-10 px-4 py-2': parent.props.size === null,
        ...
        // Secondary Button
        {
          'text-primary-800 dark:text-surface-900':
          ...
          'bg-surface-100 dark:bg-surface-400':
            ...
            && !parent.props.outlined
            && !parent.props.plain,
          'border border-surface-800 dark:border-surface-400':
            parent.props.severity === 'secondary'
            && !parent.props.text
            && !parent.props.outlined
            && !parent.props.plain,
    ...
    content: ({ context }: { context: any }) => ({
      class: [
        ...
        // Hover States
        {
          ...
          'hover:bg-primary/50 dark:hover:bg-primary-300/30 text-primary-700 dark:text-surface-0/80': context.active,
        },
        // Transitions
        'transition-shadow',
        'duration-200',
